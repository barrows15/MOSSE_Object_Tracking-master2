...
import cv2
import os
from utils import linear_mapping, pre_process, random_warp,converting_to_hog
...
class mosse:
    ...
    def start_tracking(self):
        ...
        init_frame = converting_to_hog(init_frame)#+++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        for idx in range(len(self.frame_lists)):
            ...
            frame_gray = converting_to_hog(frame_gray)#+++++++++++++++++++++++++++++++++++++++++==
